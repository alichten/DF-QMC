program dfpt_mpi
  ...
  ! ==========================================================
  ! 
  ! Dual Fermion Perturbation Theory code 
  ! based on the lattice DQMC (QUEST)
  ! 1-st order DF-expantion in Mu and t'
  ! developed by
  ! 
  ! Alexander Lichtenstein 
  ! alexander.lichten@uni-hamburg.de
  ! 
  ! with help for QUEST-version by Edin Kapetanović 
  ! ==========================================================
  ...
  if (mpi_rank .eq. master) then
    ...
    ! Write to File
    call DFPT_Write_Lattice_G(N,L,tm%dtau,lattG,Sdual)
  end if
